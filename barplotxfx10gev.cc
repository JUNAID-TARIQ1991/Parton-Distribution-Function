...
TFile *input2=new TFile("dbar1.root","read");
TTree *tree2=(TTree*)input2->Get("dbar10gev");
Double_t a,b;
...
TFile *input3=new TFile("ubar1.root","read");
...
TFile *input4=new TFile("sbar1.root","read");
...
TFile *input5=new TFile("cbar1.root","read");
...
TFile *input6=new TFile("bbar1.root","read");
