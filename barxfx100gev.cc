...
TFile *input1=new TFile("gluonoutput1.root","read");
TTree *tree1=(TTree*)input1->Get("gluon100");
Double_t x,z;
...
TFile *input2=new TFile("dbar2.root","read");
TTree *tree2=(TTree*)input2->Get("d100gev");
Double_t a,b;
...
TFile *input3=new TFile("ubar2.root","read");
TTree *tree3=(TTree*)input3->Get("u100gev");
Double_t c,d;
...
TFile *input4=new TFile("sbar2.root","read");
TTree *tree4=(TTree*)input4->Get("s100gev");
Double_t e,f;
...
TFile *input5=new TFile("cbar2.root","read");
TTree *tree5=(TTree*)input5->Get("c100gev");
Double_t g,h;
...
TFile *input6=new TFile("bbar2.root","read");
TTree *tree6=(TTree*)input6->Get("b100gev");
Double_t i,j;
...
leg->SetHeader("NNPDF31_NNLO at q^{2}=100GeV^{2}","c");
