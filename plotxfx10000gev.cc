...
TFile *input2=new TFile("doutput3.root","read");
...
TFile *input3=new TFile("uoutput3.root","read");
...
TFile *input4=new TFile("soutput3.root","read");
...
TFile *input5=new TFile("coutput3.root","read");
...
TFile *input6=new TFile("boutput3.root","read");
