void plotxfx100gev(){
TCanvas *C1=new TCanvas("xfx100gev","plot",100,100,1000,1000);
C1->SetLogx();
C1->SetTickx();
C1->SetTicky();
...
TFile *input2=new TFile("doutput1.root","read");
...
TFile *input3=new TFile("uoutput1.root","read");
...
TFile *input4=new TFile("soutput1.root","read");
...
TFile *input5=new TFile("coutput1.root","read");
...
TFile *input6=new TFile("boutput1.root","read");
...
leg->SetHeader("NNPDF31_NNLO at q2=100GeV^{2}","c");
...
gPad->Update();
gPad->Modified();
mg->GetXaxis()->SetRangeUser(1e-03,1);
mg->GetYaxis()->SetRangeUser(0,2);
}
