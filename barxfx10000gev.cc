...
TFile *input1=new TFile("gluonoutput3.root","read");
TTree *tree1=(TTree*)input1->Get("gluon10000");
Double_t x,z;
...
TFile *input2=new TFile("dbar3.root","read");
TTree *tree2=(TTree*)input2->Get("d10000gev");
Double_t a,b;
...
TFile *input3=new TFile("ubar3.root","read");
TTree *tree3=(TTree*)input3->Get("u10000gev");
Double_t c,d;
...
TFile *input4=new TFile("sbar3.root","read");
TTree *tree4=(TTree*)input4->Get("s10000gev");
Double_t e,f;
...
TFile *input5=new TFile("cbar3.root","read");
TTree *tree5=(TTree*)input5->Get("c10000gev");
Double_t g,h;
...
TFile *input6=new TFile("bbar3.root","read");
TTree *tree6=(TTree*)input6->Get("b10000gev");
Double_t i,j;
...
leg->SetHeader("NNPDF31_NNLO at q^{2}=10^{4}GeV^{2}","c");
leg->SetTextSize(0.04);


TLegendEntry *le1 = leg->AddEntry(gr1,"xf, flav =g/5","l");
TLegendEntry *le2 = leg->AddEntry(gr2,"xf, flav =#bar{d}","l");
TLegendEntry *le3 = leg->AddEntry(gr3,"xf, flav =#bar{u}","l");
TLegendEntry *le4 = leg->AddEntry(gr4,"xf, flav =#bar{s}","l");
TLegendEntry *le5 = leg->AddEntry(gr5,"xf, flav =#bar{c}","l");
TLegendEntry *le6 = leg->AddEntry(gr6,"xf, flav =#bar{b}","l");
leg->SetBorderSize(0);
leg->Draw();

gPad->Update();
gPad->Modified();
//mg->GetXaxis()->SetRange(0.001,1);
mg->GetYaxis()->SetRangeUser(0,2);
}
