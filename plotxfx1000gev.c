void plotxfx1000gev(){
TCanvas *C1=new TCanvas("xfx1000gev","plot",100,100,1000,1000);
C1->SetLogx();
C1->SetTickx();
C1->SetTicky();
...
TFile *input1=new TFile("gluonoutput2.root","read");
TTree *tree1=(TTree*)input1->Get("gluon1000");
Double_t x,z;
...
TFile *input2=new TFile("doutput2.root","read");
TTree *tree2=(TTree*)input2->Get("d1000gev");
Double_t a,b;
...
TFile *input3=new TFile("uoutput2.root","read");
TTree *tree3=(TTree*)input3->Get("u1000gev");
Double_t c,d;
...
TFile *input4=new TFile("soutput2.root","read");
TTree *tree4=(TTree*)input4->Get("s1000gev");
Double_t e,f;
...
TFile *input5=new TFile("coutput2.root","read");
TTree *tree5=(TTree*)input5->Get("c1000gev");
Double_t g,h;
...
TFile *input6=new TFile("boutput2.root","read");
TTree *tree6=(TTree*)input6->Get("b1000gev");
Double_t i,j;
...
leg->SetHeader("NNPDF31_NNLO at q2=10^{3}GeV^{2}","c");
leg->SetTextSize(0.04);

TLegendEntry *le1 = leg->AddEntry(gr1,"xf, flav =g/10","l");
